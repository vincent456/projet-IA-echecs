...
public class Position {
	...
	/*
	 * Le numero de colonne corrspondant � la coordonn�es X et le numero de ligne �
	 * la coordonn�es Y, je trouve plus naturel d'inscrire les positions avec une
	 * notation X,Y. J'ai donc inverser ces deux param�tres.
	 */
	/**
